...
const uploadProduct = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, saveProduct, "Product Uploaded Successfully"));
});
...
const updateProduct = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(
      new ApiResponse(201, productToUpdate, "Product Updated Successfully")
    );
});
...
const searchProduct = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, product, "Search Product List Fetched"));
});
...
const getCategoryWiseProducts = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, product, "Category WIse Product Fetched"));
});
...
const getProductCategory = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, productByCatgeory, "Catergory Products"));
});
...
const filterProduct = asyncHandler(async (req, res) => {
  ...
  res
    .status(201)
    .json(new ApiResponse(201, product, "Product Filetered Succesfully"));
});
